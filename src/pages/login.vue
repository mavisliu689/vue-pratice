<template>
    <div id="login">
        <img src="src/assets/image/www.jpg" class="responsive-img" style="width: 100px; height 100px;">
        <div class="container">
            <div class="form-signin">
                <!-- <div class="row"> -->
                    <div class="slideThree center-block">
                        <input
                            type="checkbox"
                            v-model="lang"
                            :true-value="'tw'"
                ...
                <input
                    ...
                    id="email"
                    class="form-control"
                    :placeholder="'Email_address'" required autofocus />
                ...
                <div class="squaredFour" style="margin:20px 10px;">
                    <input
                        ...
                        id="togglePassword" />
                    <label for="togglePassword" class="check-icon"></label>
                ...
                <br/>
                <small>email mavisliu@cloudybay.com.tw</small>
